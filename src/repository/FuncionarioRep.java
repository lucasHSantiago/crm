...
public class FuncionarioRep {
    ...
    private static final String SELECT = "select id_funcionario, id_pessoa, login_funcionario, senha_funcionario from funcionario";
    ...
    private static final String UPDATE = "update funcionario set login_funcionario = ?,  senha_funcionario = ? where id_funcionario = ?";
    ...
    public void salvar(Funcionario funcionario) {
        ...
        try {
            if (funcionario.getId() > 0) {
                ...
                pstm.setString(1, funcionario.getLoginFuncionario());
                pstm.setString(2, funcionario.getSenhaFuncionario());
                pstm.setInt(3, funcionario.getIdPessoa());
            }
            pstm.execute();
            pstm.close();
